    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <aside className="space-y-6">
          ...
          {/* Latest Blogs */}
          <div className="pt-5 ">
            <ul className="space-y-4 bg-white rounded-[7px] p-5 shadow-[0_0_10px_2px_rgba(0,0,0,0.05)] border-0 opacity-100">
              <h3 className="text-xl font-bold pt-4 pb-3">LATEST BLOGS</h3>
              {latestBlog.map((blog) => {
                const encryptedId = encryptId(blog._id);
                return (
